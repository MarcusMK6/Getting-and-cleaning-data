...
## Merging the data by row for each variable and then combining the cols--------
...
## Collencting mean and standarddeviation from chosen variables ----------------
TidyData <- Merged_Data %>% select(subject, code, contains("mean"), 
                                   contains("std"))
## -----------------------------------------------------------------------------

## Returning label of acticity to col Code--------------------------------------
